...
socket.on('execute-move', movement=>{
    console.log(movement);
    player.xDirection=movement
});
socket.on('execute-stop',stop=>{
    console.log(stop);
    player.xDirection=stop
})
...
async function getFinalScore() {
    // aquí debo poner un fetch que traiga el puntaje final desde el server y luego activar render score para mostrarlo
}
